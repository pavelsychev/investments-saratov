(() => {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    !(function () {
      const e = document.querySelectorAll('.js-dropdown-list');
      let t = !1;
      e.forEach((e) => {
        if (e.classList.contains('steps-investor__item') && !t) {
          const s = e.querySelector('.js-dropdown-content'),
            i = s.scrollHeight;
          (s.style.height = `${i}px`), e.classList.add('active'), (t = !0);
        }
      });
    })(),
      document.querySelector('.js-dropdown-list') &&
        document.querySelectorAll('.js-dropdown-list').forEach((e) => {
          const t = e.querySelector('.js-dropdown-title'),
            s = e.querySelector('.js-dropdown-content');
          ((e.classList.contains('footer__list') && window.innerWidth < 768) ||
            !e.classList.contains('footer__list')) &&
            t.addEventListener('click', () => {
              const t = s.scrollHeight;
              e.classList.contains('active') ? (s.style.height = '0px') : (s.style.height = `${t}px`),
                e.classList.toggle('active');
            });
        }),
      (function () {
        const e = document.querySelector('.js-calc-items');
        if (e && window.innerWidth < 768) {
          const t = e.querySelector('span'),
            s = document.querySelector('.js-calc-items-content');
          e.addEventListener('click', () => {
            e.classList.contains('--hide')
              ? ((t.textContent = 'Показать еще'), e.classList.remove('--hide'), s.classList.add('--hide'))
              : ((t.textContent = 'Свернуть'), s.classList.remove('--hide'), e.classList.add('--hide'));
          });
        }
      })();
  });
          ...
          void 0 !== r &&
            ...
            (o(e[i]) && o(a[i])
              ? a[i].__swiper__
                ...
                : d(e[i], a[i])
              : !o(e[i]) && o(a[i])
                ? ((e[i] = {}), a[i].__swiper__ ? (e[i] = a[i]) : d(e[i], a[i]))
                : (e[i] = a[i]));
        }
      }
    }
  ...
  const x = (e, t) => {
    ...
    L = (e) => {
      ...
      else for (let i = Math.max(a - t, 0); i <= Math.min(r + t, s - 1); i += 1) i !== a && (i > r || i < a) && C(e, i);
    };
  var M = {
    updateSize: function () {
      const e = this;
    ...
    updateSlides: function () {
      ...
      const s = e.params,
        ...
        p = u(a, `.${e.params.slideClass}, swiper-slide`),
      ...
      'string' == typeof E && E.indexOf('%') >= 0
        ...
        s.centeredSlides &&
          s.cssMode &&
          (c(i, '--swiper-centered-offset-before', ''), c(i, '--swiper-centered-offset-after', ''));
      ...
      for (let i = 0; i < m; i += 1) {
        let a;
        if (((P = 0), p[i] && (a = p[i]), M && e.grid.updateSlide(i, a, p), !p[i] || 'none' !== f(a, 'display'))) {
          if ('auto' === s.slidesPerView) {
            ...
            if ((n && (a.style.transform = 'none'), l && (a.style.webkitTransform = 'none'), s.roundLengths))
              P = e.isHorizontal() ? w(a, 'width', !0) : w(a, 'height', !0);
            else {
              const e = t(r, 'width'),
                s = t(r, 'padding-left'),
                i = t(r, 'padding-right'),
            ...
            (P = (r - (s.slidesPerView - 1) * E) / s.slidesPerView),
              ...
              p[i] && (p[i].style[e.getDirectionLabel('width')] = `${P}px`);
          p[i] && (p[i].swiperSlideSize = P),
            ...
            s.centeredSlides
              ? ((x = x + P / 2 + C / 2 + E),
                ...
                L % s.slidesPerGroup == 0 && h.push(x),
                v.push(x))
              : (s.roundLengths && (x = Math.floor(x)),
                (L - Math.min(e.params.slidesPerGroupSkip, L)) % e.params.slidesPerGroup == 0 && h.push(x),
                v.push(x),
                (x = x + P + E)),
            (e.virtualSize += P + E),
            (C = P),
      ...
      if (
        ...
        M && e.grid.updateWrapperSize(P, h),
        !s.centeredSlides)
      ) {
        const t = [];
      ...
      if (o && s.loop) {
        ...
        for (let i = 0; i < e.virtual.slidesBefore + e.virtual.slidesAfter; i += 1)
          1 === s.slidesPerGroup && h.push(h[h.length - 1] + t), v.push(v[v.length - 1] + t), (e.virtualSize += t);
      }
      ...
      if (
        (Object.assign(e, { slides: p, snapGrid: h, slidesGrid: v, slidesSizesGrid: g }),
        s.centeredSlides && s.cssMode && !s.centeredSlidesBounds)
      ) {
        c(i, '--swiper-centered-offset-before', -h[0] + 'px'),
          c(i, '--swiper-centered-offset-after', e.size / 2 - g[g.length - 1] / 2 + 'px');
        ...
        if (a.params.loop)
          if (a.virtual && a.params.virtual.enabled) n += a.virtual.slidesBefore;
            ...
            'auto' === i
              ...
              : ((i = Math.ceil(parseFloat(a.params.slidesPerView, 10))), s && i % 2 == 0 && (i += 1));
            let l = t - e < i;
          ...
          (a = parseInt(e.clickedSlide.getAttribute('data-swiper-slide-index'), 10)),
            t.centeredSlides
              ? r < e.loopedSlides - i / 2 || r > e.slides.length - e.loopedSlides + i / 2
                ? (e.loopFix(),
                  (r = e.getSlideIndex(u(s, `${l}[data-swiper-slide-index="${a}"]`)[0])),
                  n(() => {
                    e.slideTo(r);
                  }))
                : e.slideTo(r)
    ...
    k = {
      ...
      loopFix: function (e) {
        ...
        const b = [],
          S = [];
        let T = o.activeIndex;
        void 0 === r ? (r = o.getSlideIndex(d.filter((e) => e.classList.contains(h.slideActiveClass))[0])) : (T = r);
        const E = 'next' === i || !i,
          x = 'prev' === i || !i;
        let C = 0,
          L = 0;
        const M = y ? Math.ceil(d.length / h.grid.rows) : d.length,
          P = (y ? d[r].column : r) + (f && void 0 === a ? -v / 2 + 0.5 : 0);
        if (P < w) {
          C = Math.max(w - P, g);
  ...
  function O(e) {
    ...
    if ('touchstart' === a.type) return void I(t, a, a.targetTouches[0].pageX);
    ...
    (!o.touchStartForcePreventDefault && !y) || p.isContentEditable || a.preventDefault(),
  ...
  function z(e) {
    ...
    if ('touchmove' === p.type) {
      if (((c = [...p.changedTouches].filter((e) => e.identifier === a.touchId)[0]), !c || c.identifier !== a.touchId))
        return;
    } else c = p;
    ...
    if (!s.allowTouchMove)
      return (
        ...
        void (
          a.isTouched &&
          (Object.assign(n, { startX: u, startY: m, currentX: u, currentY: m }), (a.touchStartTime = l()))
        )
      );
    ...
    r.oneWayMovement && ((v = Math.abs(v) * (o ? 1 : -1)), (g = Math.abs(g) * (o ? 1 : -1))),
      (n.diff = v),
      (v *= r.touchRatio),
      o && ((v = -v), (g = -g));
    ...
    if (
      (new Date().getTime(),
      a.isMoved && a.allowThresholdMove && w !== s.touchesDirection && y && b && Math.abs(v) >= 1)
    )
      return (
      ...
      v > 0
        ? (y &&
          ...
          a.currentTranslate > s.minTranslate() &&
            ((S = !1),
            r.resistance &&
              (a.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + a.startTranslate + v) ** T)))
        : v < 0 &&
          (y &&
            b &&
            a.allowThresholdMove &&
          ...
          a.currentTranslate < s.maxTranslate() &&
            ((S = !1),
            r.resistance &&
              (a.currentTranslate = s.maxTranslate() + 1 - (s.maxTranslate() - a.startTranslate - v) ** T))),
  ...
  function _(e) {
    ...
    if (
      ...
      (!['pointercancel', 'contextmenu'].includes(a.type) || (!t.browser.isSafari && !t.browser.isWebView))
    )
      return;
    ...
    r.rewind &&
      (t.isBeginning
        ? (y = r.virtual && r.virtual.enabled && t.virtual ? t.virtual.slides.length - 1 : t.slides.length - 1)
        : t.isEnd && (w = 0));
    const b = (h - c[v]) / g,
    ...
    if (m > r.longSwipesMs) {
      ...
      'next' === t.swipeDirection &&
        (b >= r.longSwipesRatio ? t.slideTo(r.rewind && t.isEnd ? w : v + S) : t.slideTo(v)),
      ...
      !t.navigation || (a.target !== t.navigation.nextEl && a.target !== t.navigation.prevEl)
        ? ('next' === t.swipeDirection && t.slideTo(null !== w ? w : v + S),
  ...
  const F = (e, t) => {
      ...
      s[d]('touchstart', e.onDocumentTouchStart, { passive: !1, capture: o }),
        ...
        a.updateOnWindowResize
          ? e[c](l.ios || l.android ? 'resize orientationchange observerUpdate' : 'resize observerUpdate', D, !0)
        ...
        translateTo: function (e, t, s, i, a) {
          ...
          if (((c = i && e > o ? o : i && e < d ? d : e), r.updateProgress(c), n.cssMode)) {
            ...
            if (0 === t) l[e ? 'scrollLeft' : 'scrollTop'] = -c;
              ...
              if (!r.support.smoothScroll) return p({ swiper: r, targetPosition: -c, side: e ? 'left' : 'top' }), !0;
      ...
      transition: {
        ...
        transitionStart: function (e, t) {
          ...
          const s = this,
            { params: i } = s;
          i.cssMode ||
            (i.autoHeight && s.updateAutoHeight(), P({ swiper: s, runCallbacks: e, direction: t, step: 'Start' }));
        },
        transitionEnd: function (e, t) {
          ...
          const s = this,
            { params: i } = s;
          (s.animating = !1),
            i.cssMode || (s.setTransition(0), P({ swiper: s, runCallbacks: e, direction: t, step: 'End' }));
        },
      },
      slide: A,
      loop: k,
      ...
      events: {
        attachEvents: function () {
          ...
          (e.onTouchStart = O.bind(e)),
            ...
            (e.onDocumentTouchStart = B.bind(e)),
  ...
  class W {
    ...
    slidesPerViewDynamic(e, t) {
      ...
      if (s.centeredSlides) {
        ...
        for (let e = l + 1; e < i.length; e += 1) (t ? a[e] + r[e] - a[l] < n : a[e] - a[l] < n) && (o += 1);
    ...
    mount(e) {
      ...
      let a = s && s.shadowRoot && s.shadowRoot.querySelector ? s.shadowRoot.querySelector(i()) : u(s, i())[0];
      return (
        !a &&
        ...
        Object.assign(t, {
          ...
          rtlTranslate:
            'horizontal' === t.params.direction && ('rtl' === s.dir.toLowerCase() || 'rtl' === f(s, 'direction')),
    ...
    return (
      e.params.createElements &&
        Object.keys(i).forEach((a) => {
          if (!s[a] && !0 === s.auto) {
            let r = u(e.el, `.${i[a]}`)[0];
            r || ((r = h('div', i[a])), (r.className = i[a]), e.el.append(r)), (s[a] = r), (t[a] = r);
          }
        }),
      s
    );
  ...
  function X(e) {
    ...
    function p() {
      ...
      if (
        ((t.params.navigation = Y(t, t.originalParams.navigation, t.params.navigation, {
  ...
  function K(e) {
    ...
    function u() {
        ...
        if (
          ...
          a.forEach((e) => {
            ...
            a === i
              ...
              s.dynamicBullets &&
                (a >= o && a <= d && e.classList.add(...`${s.bulletActiveClass}-main`.split(' ')),
                a === o && c(e, 'prev'),
                a === d && c(e, 'next'));
          });
        else {
      ...
      p.forEach((e, r) => {
        ...
        'custom' === s.type && s.renderCustom
          ? ((e.innerHTML = s.renderCustom(t, i + 1, m)), 0 === r && a('paginationRender', e))
      ...
      'string' == typeof e.el && t.isElement && (s = t.el.querySelector(e.el)),
        ...
        s &&
          ...
          (t.params.uniqueNavElements &&
            ...
            s.length > 1 && (s = s.filter((e) => g(e, '.swiper')[0] === t.el)[0])),
    ...
    i('changeDirection', () => {
      ...
      i('init', () => {
        !1 === t.params.pagination.enabled ? y() : (h(), m(), u());
      }),
      i('activeIndexChange', () => {
  ...
  function J(e) {
    ...
    function b(e) {
      a &&
        ...
        (a.wrapperEl.removeEventListener('transitionend', b), v || L());
    }
    const S = () => {
        if (a.destroyed || !a.autoplay.running) return;
        a.autoplay.paused ? (c = !0) : c && ((w = d), (c = !1));
        const e = a.autoplay.paused ? d : y + w - new Date().getTime();
      ...
      T = (e) => {
        ...
        (g = a.params.autoplay.delay), (w = a.params.autoplay.delay);
        const r = (() => {
          let e;
          if (
            ((e =
        ...
        !Number.isNaN(r) && r > 0 && void 0 === e && ((i = r), (g = r), (w = r)), (d = i);
      ...
      E = () => {
        (y = new Date().getTime()), (a.autoplay.running = !0), T(), l('autoplayStart');
      },
      x = () => {
      ...
      C = (e, s) => {
        ...
        const i = () => {
          l('autoplayPause'),
            a.params.autoplay.waitForTransition ? a.wrapperEl.addEventListener('transitionend', b) : L();
        };
        if (((a.autoplay.paused = !0), s)) return h && (d = a.params.autoplay.delay), (h = !1), void i();
        const r = d || a.params.autoplay.delay;
        (d = r - (new Date().getTime() - y)), (a.isEnd && d < 0 && !a.params.loop) || (d < 0 && (d = 0), i());
      },
      L = () => {
        (a.isEnd && d < 0 && !a.params.loop) ||
          a.destroyed ||
          !a.autoplay.running ||
          ((y = new Date().getTime()), f ? ((f = !1), T(d)) : T(), (a.autoplay.paused = !1), l('autoplayResume'));
      },
      M = () => {
        if (a.destroyed || !a.autoplay.running) return;
        const e = i();
        'hidden' === e.visibilityState && ((f = !0), C(!0)), 'visible' === e.visibilityState && L();
      },
      P = (e) => {
        'mouse' === e.pointerType && ((f = !0), (v = !0), a.animating || a.autoplay.paused || C(!0));
      },
      A = (e) => {
        'mouse' === e.pointerType && ((v = !1), a.autoplay.paused && L());
      };
    n('init', () => {
      a.params.autoplay.enabled &&
        (a.params.autoplay.pauseOnMouseEnter &&
          (a.el.addEventListener('pointerenter', P), a.el.addEventListener('pointerleave', A)),
        i().addEventListener('visibilitychange', M),
        E());
    }),
      n('destroy', () => {
        a.el.removeEventListener('pointerenter', P),
          a.el.removeEventListener('pointerleave', A),
      ...
      n('touchEnd', () => {
        if (!a.destroyed && a.autoplay.running && p) {
          if ((clearTimeout(m), clearTimeout(t), a.params.autoplay.disableOnInteraction))
            return (u = !1), void (p = !1);
          u && a.params.cssMode && L(), (u = !1), (p = !1);
        }
      }),
      n('slideChange', () => {
        !a.destroyed && a.autoplay.running && (h = !0);
      }),
      Object.assign(a.autoplay, { start: E, stop: x, pause: C, resume: L });
  }
  function Q() {
  ...
  Object.keys(j).forEach((e) => {
    ...
    document.addEventListener('DOMContentLoaded', function () {
      !(function () {
        if (document.querySelector('.benefits__swiper')) {
          const e = document.querySelector('.benefits__swiper'),
            t = e.parentElement.querySelector('.slider-navigation__fraction'),
            s = e.parentElement.querySelector('.slider-navigation__btns-prev'),
            i = e.parentElement.querySelector('.slider-navigation__btns-next');
          new W(e, {
            modules: [K, X],
            slidesPerView: 1,
            loop: !0,
            speed: 500,
            pagination: { el: t, type: 'fraction' },
        ...
        (function () {
          if (document.querySelector('.success-hist__swiper')) {
            const e = document.querySelector('.success-hist__swiper'),
              t = e.parentElement.querySelector('.slider-navigation__fraction'),
              s = e.parentElement.querySelector('.slider-navigation__btns-prev'),
              i = e.parentElement.querySelector('.slider-navigation__btns-next');
            new W(e, {
        ...
        (function () {
          if (document.querySelector('.intro__swiper')) {
            const e = document.querySelector('.intro__swiper'),
              t = e.parentElement.querySelector('.slider-navigation__fraction'),
              s = e.parentElement.querySelector('.slider-navigation__btns-prev'),
              i = e.parentElement.querySelector('.slider-navigation__btns-next');
            new W(e, {
      ...
      e &&
        e.forEach((e) => {
          const t = e.querySelector('.js-dropdown-inner'),
            ...
            i = e.querySelectorAll('.js-dropdown-item label');
          t.addEventListener('click', () => {
            e.classList.contains('--active') ? e.classList.remove('--active') : e.classList.add('--active');
          });
          for (let t = 0; t < i.length; t += 1)
            i[t].addEventListener('click', (t) => {
              s && ((s.textContent = t.target.textContent), e.classList.add('--filled')),
                e.classList.contains('dropdown-mult') || e.classList.remove('--active');
            });
          document.addEventListener('click', (t) => {
            t.target.closest('.js-dropdown') || e.classList.remove('--active');
          });
        });
    }),
    (function () {
      if (document.querySelector('.input')) {
        ...
        e.forEach((e) => {
          null !== e.querySelector('input').getAttribute('disabled')
            ? e.classList.add('--disabled')
            : e.classList.remove('-disabled');
        }),
          e.forEach((e) => {
            const t = e.querySelector('input'),
              s = e.querySelector('.input__input');
            s &&
              (s.addEventListener('click', () => t.focus()),
              t.addEventListener('focus', () => e.classList.add('--focus')),
              t.addEventListener('blur', () => e.classList.remove('--focus')));
          });
      }
    })(),
    (function () {
      if (document.querySelector('.textarea')) {
        ...
        e.forEach((e) => {
          null !== e.querySelector('textarea').getAttribute('disabled')
            ? e.classList.add('--disabled')
            : e.classList.remove('-disabled');
        }),
          e.forEach((e) => {
            const t = e.querySelector('textarea');
            e.querySelector('.textarea__textarea').addEventListener('click', () => t.focus()),
              t.addEventListener('focus', () => e.classList.add('--focus')),
              t.addEventListener('blur', () => e.classList.remove('--focus'));
          });
      }
    ...
    document.querySelectorAll('.input-file input[type=file]') &&
      document.querySelectorAll('.input-file').forEach((e) => {
        const t = e.querySelector('input'),
          s = e.querySelector('span');
        t.addEventListener('change', function () {
          const e = this.files[0].name;
          s.innerHTML = e;
        });
      });
  class Z {
    constructor(e) {
      (this.name = e),
        (this.modal = document.querySelector(`[data-modal="${e}"]`)),
        (this.triggers = document.querySelectorAll(`[data-modal-el="${e}"]`)),
    ...
    open() {
      this.modal.classList.remove('success', 'error'),
        ...
        (document.body.style.width = document.body.clientWidth - Q() + 'px'),
        this.modal.addEventListener('click', this.closeHendler),
        Q(),
        this.changeModalContent(this);
    }
    changeModalContent(e) {
      if (e.modal.querySelector('.--main') && e.modal.querySelector('.--success')) {
        const t = e.modal.querySelector('.--main'),
          s = e.modal.querySelector('.--success');
        (t.style = ''), (s.style.display = 'none');
      }
    }
    close() {
    ...
    success() {
      this.modal.classList.remove('error'), this.modal.classList.add('success');
    }
    error() {
      this.modal.classList.remove('success'), this.modal.classList.add('error');
    }
    update() {
    ...
    closeHendler = (e) => {
      e.target.classList.contains('close-x') && this.close();
    };
  }
  document.querySelector('[data-modal="write-request"]') && new Z('write-request'),
    document.querySelector('[data-modal="account-create-success"]') && new Z('account-create-success'),
    document.querySelector('[data-modal="email-confirmed"]') && new Z('email-confirmed'),
    document.querySelector('[data-modal="request-sent"]') && new Z('request-sent'),
    document.querySelector('[data-modal="exit-confirmation"]') && new Z('exit-confirmation'),
    (function () {
      const e = document.querySelector('.modal-write'),
        t = document.querySelector('.modal-write.--success');
      document.querySelector('.modal-write__btns .btn-def').addEventListener('click', () => {
        var s;
        ((s = e).style.opacity = 1),
          (s.style.transition = 'opacity 0ms'),
          (s.style.opacity = 0),
          setTimeout(() => {
          ...
          ((e, t, s) => {
            (e.style.opacity = 0),
              ...
              (e.style.transition = 'opacity 750ms'),
              setTimeout(() => {
                e.style.opacity = 1;
              }, 10);
          })(t);
  ...
  document.addEventListener('DOMContentLoaded', () => {
    window.location.href.includes('main') &&
      (window.pageYOffset >= 6 && ee.classList.remove('header--transparent'),
      (window.onscroll = () => {
        window.pageYOffset > 6 ? ee.classList.remove('header--transparent') : ee.classList.add('header--transparent');
      }));
  }),
    (function (e) {
      const t = new Image();
